...
export const ru: Record<string, string> = {
  ...
  'settings.session.unlink_footer':
    'Выходит и очищает этот веб-аккаунт из браузера (сообщения, контакты, ключи). Аккаунт хранится только здесь, поэтому после выхода он теряется навсегда.',
  ...
  'uin_market.info.migrate.title': 'Что происходит при покупке',
  'uin_market.info.migrate.body':
    'Аккаунт переедет на новый UIN. Профиль и контакты останутся с вами, защищённые сессии сбросятся и переустановятся при следующем сообщении. Старый UIN освободится.',
  'uin_market.confirm.body':
    'Аккаунт переедет на этот UIN. Профиль и контакты сохранятся, защищённые сессии сбросятся и переустановятся автоматически. Старый UIN освободится.',
  'uin_market.confirm.cta': 'Подтвердить',
  'uin_market.bought.title': 'Готово',
  'uin_market.bought.body': 'Теперь ваш номер {uin}.',
